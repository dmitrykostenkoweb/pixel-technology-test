<template>
  <div class="loadingio-spinner-spin-7utejk0tka">
    <div class="ldio-njrzo5dgax">
      <div><div></div></div>
      <div><div></div></div>
      <div><div></div></div>
      <div><div></div></div>
...
.ldio-njrzo5dgax > div:nth-child(8) {
  transform: rotate(315deg);
  transform-origin: 142px 58px;
}
.loadingio-spinner-spin-7utejk0tka {
  width: 200px;
  height: 200px;
